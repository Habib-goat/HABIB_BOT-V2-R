...
module.exports.onStart = async function ({ api, event, args, usersData }) {
	...
	try {
		...
		const getBotResponse = async (text, attachments) => {
			try {
				const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments, senderID: uid });
...
module.exports.onReply = async function ({ api, event }) {
	...
	try {
		const getBotResponse = async (text, attachments) => {
			try {
				const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments, senderID: event.senderID });
				return res.data.message;
			} catch {
				return "error baby🥹";
			}
	...
	try {
		...
		if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
			...
			const randomMessage = [
				...
				"তোমার কথা ভাবতে ভাবতে চা ঠান্ডা হয়ে গেল ☕❤️",
				"তুমি কি GPS? কারণ তুমি ছাড়া আমি হারিয়ে যাই 🗺️💗",
				"বাবু, তোমার হাসি না দেখলে দিনটাই অফ 💕",
				"তুমি ডাকলে আমার চার্জ 100% হয়ে যায় 🔋😘",
				"তুমি ছাড়া আমি WiFi ছাড়া ফোনের মতো 📶💔",
				"আমার হৃৎপিণ্ডের অ্যাডমিন তুমি ❤️‍🔥",
				"তুমি কি জাদুকর? দেখলেই মন ভাল হয়ে যায় ✨",
				"বাবু, তুমি আমার গুগল... কারণ আমার সব উত্তর তুমি 💌",
				"তুমি না থাকলে ফেসবুকও বোরিং লাগে 📱💗",
				"আমার হৃদয়ের সিমে শুধু তোমার নাম সেভ আছে 📞❤️",
				"তুমি আসলেই আবহাওয়া সুন্দর হয়ে যায় 🌤️😘",
				"আমার হোয়াটসঅ্যাপের টপ চ্যাট শুধু তুমি 💚",
				"তুমি না থাকলে মনে হয় চার্জার খুলে গেছে 🔌💔",
				"আমার হার্টে তোমার নটিফিকেশন সবসময় অন 📲💖",
				"তুমি কি কফি? তোমাকে ছাড়া ঘুম ভাঙে না ☕😍",
				"তুমি আমার লাইফের VIP গ্রুপে অ্যাড আছো 👑",
				"তুমি পাশে থাকলেই মনে হয় নেট ফাস্ট হয়ে গেছে ⚡💗",
				"তুমি কি মেঘ? আমার মন বৃষ্টিতে ভিজিয়ে দাও 🌧️❤️",
				"তুমি ছাড়া আমি অফলাইন ইউজারের মতো 😅",
				...
				"আমার বস রিয়াদের পক্ষ থেকে তোমারে এতো এতো ভালোবাসা-🥰😽🫶 আমার বস রিয়াদ ইসলামে'র জন্য দোয়া করবেন-💝💚🌺🌻",
				...
				"—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার বস রিয়াদ এর সাথে প্রেম করে তাকে দেখিয়ে দাও-🙈🐸🤗",
				...
				"সুন্দর মাইয়া মানেই-🥱আমার বস রিয়াদের বউ-😽🫶আর বাকি গুলো আমার বেয়াইন-🙈🐸🤗",
				...
				"-𝗜 𝗟𝗢𝐕𝗘 𝗬𝗢𝐔-😽-আহারে ভাবছো তোমারে প্রোপজ করছি-🥴-থাপ্পর দিয়া কিডনী লক করে দিব-😒-ভুল পড়া বের করে দিবো-🤭🐸",
				...
				"-ওই বেডি তোমার বাসায় না আমার বস রিয়াদ মেয়ে দেখতে গেছিলো-🙃-নাস্তা আনারস আর দুধ দিছো-🙄🤦‍♂️-বইন কইলেই তো হয় বয়ফ্রেন্ড আছে-🥺🤦‍♂️-আমার বস রিয়াদ কে জানে মারার কি দরকার-🙄🤧",
				...
				"-দেশের সব কিছুই চুরি হচ্ছে-🙄-শুধু আমার বস রিয়াদ এর মনটা ছাড়া-🥴😑😏",
